      ...
      <div class="page-container py-16">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div class="md:col-span-2">
            <h3 class="text-xs font-semibold tracking-widest uppercase mb-5" class="text-white/40">{{ 'footer.nav_title' | translate }}</h3>
            <ul class="space-y-3">
          ...
          <!-- Legal -->
          <div class="md:col-span-2">
            <h3 class="text-xs font-semibold tracking-widest uppercase mb-5" class="text-white/40">{{ 'footer.legal_title' | translate }}</h3>
            <ul class="space-y-3">
          ...
          <!-- Newsletter -->
          <div class="md:col-span-4">
            <h3 class="text-xs font-semibold tracking-widest uppercase mb-5" class="text-white/40">{{ 'footer.newsletter_title' | translate }}</h3>
