...
@Component({
  ...
  imports: [RouterLink],
  template: `
    <footer class="hidden md:block" style="background-color: #111E35;">
      <!-- Main footer grid -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div class="md:col-span-4">
            <div class="flex items-center gap-3 mb-5">
              <div class="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0" style="background-color: #007A7C;">
              ...
              <div class="leading-none">
                ...
                <span class="text-xs font-medium tracking-widest uppercase" style="color: #2DAAAA;">Systems</span>
              </div>
            </div>
            ...
            <div class="space-y-2.5 text-sm mb-6" style="color: rgba(255,255,255,0.5);">
              <div class="flex items-center gap-2.5">
                <svg class="w-4 h-4 flex-shrink-0" style="color: #007A7C;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="flex items-start gap-2.5">
                <svg class="w-4 h-4 flex-shrink-0 mt-0.5" style="color: #007A7C;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex gap-2">
              <a href="#" class="w-8 h-8 rounded-lg flex items-center justify-center transition-all" style="background:rgba(255,255,255,0.08);"
                onmouseenter="this.style.background='#007A7C'" onmouseleave="this.style.background='rgba(255,255,255,0.08)'">
          ...
          <div class="md:col-span-4">
            ...
            <form class="flex gap-2" (submit)="$event.preventDefault()">
              ...
              <button type="submit" class="px-4 py-2.5 rounded-lg text-sm font-medium text-white transition-all flex-shrink-0"
                style="background:#007A7C;"
                onmouseenter="this.style.background='#005C5D'" onmouseleave="this.style.background='#007A7C'">
                S'abonner
              </button>
            </form>
            ...
            <div class="mt-6 pt-6 border-t flex flex-wrap gap-3" style="border-color:rgba(255,255,255,0.08);">
              <div class="flex items-center gap-1.5 text-xs" style="color:rgba(255,255,255,0.4);">
                <svg class="w-4 h-4" style="color:#007A7C;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
