      ...
      <div class="page-container py-16">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div class="md:col-span-4">
            ...
            <div class="space-y-2.5 text-sm mb-6 text-white/50">
              <div class="flex items-center gap-2.5">
                <svg class="w-4 h-4 flex-shrink-0" class="text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="flex items-start gap-2.5">
                <svg class="w-4 h-4 flex-shrink-0 mt-0.5" class="text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex gap-2">
              <a href="#" aria-label="LinkedIn Althea Systems"
              ...
              <a href="#" aria-label="Facebook Althea Systems"
                class="w-8 h-8 rounded-lg flex items-center justify-center transition-all bg-white/[0.08] hover:bg-primary">
                <svg class="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div class="md:col-span-2">
            <h3 class="text-xs font-semibold tracking-widest uppercase mb-5" class="text-white/40">Navigation</h3>
            <ul class="space-y-3">
              <li><a routerLink="/" class="text-sm transition-colors text-white/60 hover:text-white">Accueil</a></li>
              <li><a routerLink="/recherche" class="text-sm transition-colors text-white/60 hover:text-white">Catalogue</a></li>
              <li><a routerLink="/contact" class="text-sm transition-colors text-white/60 hover:text-white">Contact</a></li>
              <li><a href="#" class="text-sm transition-colors text-white/60 hover:text-white">À propos</a></li>
              <li><a href="#" class="text-sm transition-colors text-white/60 hover:text-white">Blog</a></li>
            </ul>
          </div>

          <!-- Legal -->
          <div class="md:col-span-2">
            <h3 class="text-xs font-semibold tracking-widest uppercase mb-5" class="text-white/40">Légal</h3>
            <ul class="space-y-3">
              <li><a routerLink="/cgu" class="text-sm transition-colors text-white/60 hover:text-white">CGU</a></li>
              <li><a routerLink="/mentions-legales" class="text-sm transition-colors text-white/60 hover:text-white">Mentions légales</a></li>
              <li><a href="#" class="text-sm transition-colors text-white/60 hover:text-white">Confidentialité</a></li>
              <li><a href="#" class="text-sm transition-colors text-white/60 hover:text-white">Cookies</a></li>
            </ul>
          </div>

          <!-- Newsletter -->
          <div class="md:col-span-4">
            <h3 class="text-xs font-semibold tracking-widest uppercase mb-5" class="text-white/40">Restez informé</h3>
            ...
            <form class="flex gap-2" (submit)="$event.preventDefault()">
              <input
                ...
                class="bg-white/[.08] text-white caret-white"
              />
            ...
            <div class="mt-6 pt-6 border-t border-white/[.08] flex flex-wrap gap-3">
              <div class="flex items-center gap-1.5 text-xs text-white/40">
                <svg class="w-4 h-4" class="text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
