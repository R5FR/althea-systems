    ...
    <div class="min-h-screen bg-primary-100 flex items-center justify-center px-4">
      <div class="card p-10 max-w-md w-full text-center">
        @if (loading()) {
          ...
          <p class="text-gray-500">{{ 'auth.confirm_email_verifying' | translate }}</p>
        } @else if (success()) {
          ...
          <h1 class="text-xl font-bold text-gray-900 mb-2">{{ 'auth.confirm_email_success_title' | translate }}</h1>
          <p class="text-gray-500 mb-6">{{ 'auth.confirm_email_success_msg' | translate }}</p>
          ...
          <h1 class="text-xl font-bold text-gray-900 mb-2">{{ 'auth.confirm_email_error_title' | translate }}</h1>
          <p class="text-gray-500 mb-6">{{ 'auth.confirm_email_error_msg' | translate }}</p>
          <a routerLink="/register" class="btn-secondary inline-flex">{{ 'auth.confirm_email_retry' | translate }}</a>
        }
      </div>
    </div>
  `,
